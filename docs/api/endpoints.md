...
`GET /bias/evaluation` returns overall directional accuracy plus per-horizon sample size, accuracy, average realized return, and positive-return rate alongside confidence calibration.
