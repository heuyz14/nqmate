...
- Snapshot persistence slice added: migration `023_session_feature_snapshots.sql`, immutable `SessionFeatureSnapshot` metadata, and server-only insert repository support. Supabase migration application is still required before writes.
