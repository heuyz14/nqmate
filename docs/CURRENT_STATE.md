...
- Snapshot population job added at `jobs/populate_feature_snapshots.py`. Reconstructed population is complete for all 389 persisted NQ sessions through 2026-09-08: Supabase exact count is 2,334 `market-features-v2.1` snapshots (6 per session), with latest rows on 2026-09-08 NQU6. Existing snapshots are immutable and safely reused.
